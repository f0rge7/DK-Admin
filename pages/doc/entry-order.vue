<template>
	<view class="page">
		<view-doc ref="doc" :type="type" :table1="table1" :queryForm1="queryForm1" :form1="form1" :columnsNumber="3" :addVisible="false" :departments.sync="departments"></view-doc>
	</view>
			...
			return {
				...
				table1: {
					...
					columns:[
						...
						{ key:"order_id", title:"订单编号", type:"text", width:200, sortable: true },
						...
						{ key:"order_date", title:"送货日期", type:"text", width:120, sortable: true },
				...
				queryForm1:{
					...
					columns:[
						...
						{ key:"order_date", title:"送货日期", type:"date", dateType:"daterange", width:250, mode:"[]"},
					]
				},
				form1:{
					// 表单请求数据，此处可以设置默认值
