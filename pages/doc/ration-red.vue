			...
			return {
				...
				table1: {
					...
					columns:[
						...
						{ key:"department_name", title:"发货部门", type:"text", width:200, sortable: true },
						{ key:"send_name", title:"收货部门", type:"text", width:200, sortable: true },
				...
				queryForm1:{
					...
					columns:[
						...
						{ key:"department_id", title:"发货部门", type:"text", width:160, mode:"=" },
						{ key:"department_name", title:"发货名称", type:"text", width:160, mode:"%%" },
						{ key:"send_department", title:"收货部门", type:"text", width:160, mode:"=" },
						{ key:"send_name", title:"收货名称", type:"text", width:160, mode:"%%" },
					]
				},
				form1:{
					// 表单请求数据，此处可以设置默认值
