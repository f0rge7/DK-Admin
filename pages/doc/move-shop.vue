<template>
	<view class="page">
		<view-doc ref="doc" :type="type" :table1="table1" :queryForm1="queryForm1" :form1="form1" :columnsNumber="3" :addVisible="addVisible" :sends.sync="sends" :departments.sync="departments"></view-doc>
	</view>
...
<script>
	...
	export default {
		...
		computed: {
			addVisible() {
				let shop_id = vk.getVuex('$user.login.shop_id')
				let hq_id = vk.getVuex('$app.baseData')['总部']
				if (shop_id == hq_id) {
					return false
				} else {
					return true
