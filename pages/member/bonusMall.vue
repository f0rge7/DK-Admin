			...
			return {
				...
				table1:{
					...
					columns:[
						...
						{
							key:"type", title:"类型", type:"select", width:80,
							data:[
								{value: "1", label: "实物"},
								{value: "2", label: "优惠券"},
								{value: "3", label: "赠品券"}
						...
						{ key:"code", title:"编码", type:"text", width:80, sortable:"custom" },
						{ key:"name", title:"名称", type:"text", width:220 },
						{ key:"cost_bonus", title:"积分", type:"number", width:80, sortable:"custom" },
						{ key:"ori_price", title:"原价", type:"number", width:80, sortable:"custom" },
				...
				form1:{
					...
					props: {
						...
						columns:[
							{
								key:"type", title:"类型", type:"select", placeholder:"请选择类型",
								data:[
									{value: "1", label: "实物"},
									{value: "2", label: "优惠券"},
									{value: "3", label: "赠品券"}
							...
							// { key:"type", title:"类型", type:"text", placeholder:"请输入类型" },
							{ key:"code", title:"编码", type:"text", placeholder:"请输入编码" },
							{ key:"name", title:"名称", type:"text", placeholder:"请输入名称" },
							{ key:"cost_bonus", title:"积分", type:"number", placeholder:"请输入积分" },
							{ key:"ori_price", title:"原价", type:"number", placeholder:"请输入原价" },
							{ key:"image", title:"图片", type:"image", limit: 5,
								httpRequest(obj) {
							...
							{ key:"detail", title:"详情", type:"editor"},
							{ key:"memo", title:"备注", type:"text", placeholder:"请输入备注" }
						],
						// 表单验证规则
						rules:{
							code:[
