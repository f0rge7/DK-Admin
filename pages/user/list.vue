...
<script>
	...
	export default {
		...
		data() { 
			...
			return {
				...
				table1:{
					...
					// 表格字段显示规则
					columns:[
						{ key:"logo1", title:"logo1", type:"avatar", width:80 },
						{ key:"logo2", title:"logo2", type:"avatar", width:80 },
						...
						{ key:"server_ip", title:"服务器IP", type:"text", width:160 },
				...
				form1:{
					...
					props: {
						...
						columns:[
							...
							{ key:"password", title:"密码", type:"text", tips:"若密码为空，则默认为123456", show:["add"] },
							{ key:"logo1", title:"logo1", type:"image", limit: 1},
							{ key:"logo2", title:"logo2", type:"image", limit: 1},
							...
							{ key:"server_ip", title:"服务器IP", type:"text" },
							{ key:"admin_pwd", title:"Admin密码", type:"text" },
							...
							// { key:"allow_login_background", title:"允许登录", type:"switch", activeValue: true, inactiveValue: false
							// 	// data:[
							// 	// { value:true, label:"允许", tagType:"success" },
							// 	// { value:false, label:"禁止", tagType:"danger" }
							// 	// ]
		...
		onLoad(options = {}) {
			...
			that.init(options);
			console.log(this.queryForm1.formData)
		},
